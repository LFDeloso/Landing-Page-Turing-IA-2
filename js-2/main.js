...
document.addEventListener("submit", (event) => {
    ...
    const query = `
    mutation { create_item(item_name:  "MasterClass", board_id: 3189638065,
     column_values: "{\\"date4\\" : \\"${formatDate} ${formatTime}\\",\\"texto\\" : \\"${data.get("nombreCompleto")}\\", \\"texto6\\" : \\"${data.get("telefono")}\\" , \\"texto9\\" : \\"${data.get("empresa")}\\", \\"texto0\\" : \\"${data.get("email")}\\", \\"texto93\\" : \\"${data.get("puesto")}\\" , \\"texto3\\" : \\"MasterClass Analisis de Datos para Retail\\", \\"texto90\\" : \\"${capitalize(ref)}\\"}")
      {
        id
      }
    }`;
    fetch("https://api.monday.com/v2", {
      ...
      window.location.href = "https://www.addevent.com/event/fG14848968";
      });
  });